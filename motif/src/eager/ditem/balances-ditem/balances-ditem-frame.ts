...
export class BalancesDitemFrame extends BuiltinDitemFrame {
    ...
    initialise(ditemFrameElement: JsonElement | undefined, balancesFrame: BalancesFrame): void {
        ...
        balancesFrame.initialise(this.opener, undefined, false);
        ...
        openPromise.then(
            ...
            (reason: unknown) => { throw AssertInternalError.createIfNotError(reason, 'BDFIPR50139') }
        );
    }
    ...
    private processRecordFocusChange(newFocusedRecord: Balances) {
        if (!this._brokerageAccountGroupApplying) {
            ...
            try {
                const accountZenithCode = newFocusedRecord.account.zenithCode;
        ...
        try {
            ...
            if (group !== undefined) {
                ...
                promise.then(
                    ...
                    (reason: unknown) => { throw AssertInternalError.createIfNotError(reason, 'BDFABAGWO54122'); }
                );
            }
        } finally {
