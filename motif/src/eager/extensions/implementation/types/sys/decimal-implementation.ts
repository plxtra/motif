...
export namespace DecimalImplementation {
    export function toApi(value: Decimal): DecimalApi {
        return new DecimalImplementation(value);
    }

    export function fromApi(value: DecimalApi): Decimal {
