import { BinarySearchResult, UnreachableCaseError } from '@pbkware/js-utils';
import { IntervalHistorySequencer } from '@plxtra/motif-core';
import {
...
export namespace IntervalHistorySequencerImplementation {
    ...
    export class PointList extends ComparableListImplementation<IntervalHistorySequencerApi.Point> {
        declare protected readonly _actual: IntervalHistorySequencer.PointList;

        findPoint(dateTime: Date, suggestedIndex: IntegerApi): BinarySearchResult {
