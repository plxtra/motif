import { MultiEvent, SysTick, UnreachableCaseError } from '@pbkware/js-utils';
import {
    AdiService, Badness, CorrectnessId, StringId, Strings, ZenithExtConnectionDataDefinition,
...
export class ZenithStatusFrame extends ContentFrame {
    ...
    get subscriptionWarningCount() { return this._extConnectionDataItem.subscriptionWarningCount.toString(10); }
    get subscriptionErrorCount() { return this._extConnectionDataItem.subscriptionErrorCount.toString(10); }
    get dataErrorSubscriptionErrorCount() { return this._extConnectionDataItem.dataErrorSubscriptionErrorCount.toString(10); }
    get dataNotAvailableSubscriptionErrorCount() {
        return this._extConnectionDataItem.dataNotAvailableSubscriptionErrorCount.toString(10);
    }
