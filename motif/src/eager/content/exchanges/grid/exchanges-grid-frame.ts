...
import { ExchangeListTableRecordSource } from './table/exchange-list-table-record-source';
import { ExchangeListTableRecordSourceDefinition } from './table/exchange-list-table-record-source-definition';

export class ExchangesGridFrame extends GridSourceFrame {
    recordFocusedEventer: ScanFieldEditorFramesGridFrame.RecordFocusedEventer | undefined

    private _list: ChangeSubscribableComparableList<Exchange>;
    ...
    tryOpenList(list: ChangeSubscribableComparableList<Exchange>, keepView: boolean) {
    ...
    protected override getDefaultGridSourceOrReferenceDefinition() {
        const list = new ChangeSubscribableComparableList<Exchange>();
        return this.createListGridSourceOrReferenceDefinition(list, undefined);
    }

    protected override processGridSourceOpenedEvent() {
        const recordSource = this.grid.openedRecordSource as ExchangeListTableRecordSource;
    ...
    private createListGridSourceOrReferenceDefinition(list: ChangeSubscribableComparableList<Exchange>, layoutDefinition: RevColumnLayoutOrReferenceDefinition | undefined) {
        const tableRecordSourceDefinition = new ExchangeListTableRecordSourceDefinition(
