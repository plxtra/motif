import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, Inject, InjectionToken, Injector, Optional, ValueProvider, viewChild, ViewContainerRef } from '@angular/core';
...
export class DataIvemIdListEditorDialogNgComponent extends DataIvemIdListEditorNgDirective implements AfterViewInit{
    ...
    constructor(
        ...
        @Inject(DataIvemIdListEditorDialogNgComponent.captionInjectionToken) public readonly caption: string,
        ...
        super(
            ...
            toastNgService,
            ++DataIvemIdListEditorDialogNgComponent.typeInstanceCreateCount,
            opener,
            list
        );
