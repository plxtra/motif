...
import { ExchangeEnvironmentListTableRecordSource } from './table/exchange-environment-list-table-record-source';
import { ExchangeEnvironmentListTableRecordSourceDefinition } from './table/exchange-environment-list-table-record-source-definition';

export class ExchangeEnvironmentsGridFrame extends GridSourceFrame {
    recordFocusedEventer: ScanFieldEditorFramesGridFrame.RecordFocusedEventer | undefined

    private _list: ChangeSubscribableComparableList<ExchangeEnvironment>;
    ...
    tryOpenList(list: ChangeSubscribableComparableList<ExchangeEnvironment>, keepView: boolean) {
    ...
    protected override getDefaultGridSourceOrReferenceDefinition() {
        const list = new ChangeSubscribableComparableList<ExchangeEnvironment>();
        return this.createListGridSourceOrReferenceDefinition(list, undefined);
    }

    protected override processGridSourceOpenedEvent() {
        const recordSource = this.grid.openedRecordSource as ExchangeEnvironmentListTableRecordSource;
    ...
    private createListGridSourceOrReferenceDefinition(list: ChangeSubscribableComparableList<ExchangeEnvironment>, layoutDefinition: RevColumnLayoutOrReferenceDefinition | undefined) {
        const tableRecordSourceDefinition = new ExchangeEnvironmentListTableRecordSourceDefinition(
