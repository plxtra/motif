...
import { ExchangeEnvironmentsGridNgComponent as ExchangeEnvironmentsGridNgComponent_1 } from '../grid/ng/exchange-environments-grid-ng.component';
...
@Component({
    ...
    imports: [IntegerCaptionedRadioNgComponent_1, SvgButtonNgComponent_1, ExchangeEnvironmentsGridNgComponent_1]
})
