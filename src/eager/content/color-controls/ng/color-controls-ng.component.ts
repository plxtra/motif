...
@Component({
    ...
    imports: [IntegerCaptionedRadioNgComponent, TextInputNgComponent, CaptionedCheckboxNgComponent, CaptionLabelNgComponent, IntegerTextInputNgComponent, NumberInputNgComponent, SvgButtonNgComponent]
})
