...
import { TradingMarketsGridNgComponent } from '../grid/ng-api';
...
import { TradingMarketsGridNgComponent as TradingMarketsGridNgComponent_1 } from '../grid/ng/trading-markets-grid-ng.component';

@Component({
    selector: 'app-trading-markets',
    templateUrl: './trading-markets-ng.component.html',
    styleUrls: ['./trading-markets-ng.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [IntegerCaptionedRadioNgComponent_1, SvgButtonNgComponent_1, TradingMarketsGridNgComponent_1]
})
export class TradingMarketsNgComponent extends ContentComponentBaseNgDirective implements OnDestroy, AfterViewInit {
    ...
    private readonly _gridComponentSignal = viewChild.required<TradingMarketsGridNgComponent>('grid');
    ...
    private _gridComponent: TradingMarketsGridNgComponent;
    ...
    constructor() {
        super(++TradingMarketsNgComponent.typeInstanceCreateCount);
    ...
    ngAfterViewInit(): void {
        ...
        delay1Tick(() => {
            ...
            delay1Tick(() => this._cdr.markForCheck());
        });
    }
            ...
            (listId) => (
                {
                    ...
                    title: MarketsService.List.idToDescription(listId, Strings[StringId.TradingMarkets]),
                }
            )
        );
    ...
    private openList(listId: MarketsService.ListId) {
        switch (listId) {
            case MarketsService.ListId.Known:
                this._gridComponent.setList(this._marketsService.tradingMarkets);
                break;
            case MarketsService.ListId.EnvironmentDefault:
                this._gridComponent.setList(this._marketsService.defaultExchangeEnvironmentTradingMarkets);
                break;
            case MarketsService.ListId.Unknown:
                this._gridComponent.setList(this._marketsService.unknownTradingMarkets);
                break;
            default:
...
export namespace TradingMarketsNgComponent {
    ...
    export function create(container: ViewContainerRef, opener: LockOpenListItem.Opener) {
        ...
        const componentRef = container.createComponent(TradingMarketsNgComponent, { injector });
        assert(componentRef.instance instanceof TradingMarketsNgComponent, 'ENGC31175');
