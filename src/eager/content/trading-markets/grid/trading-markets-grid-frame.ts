...
import { TradingMarketListTableRecordSource } from './table/trading-market-list-table-record-source';
import { TradingMarketListTableRecordSourceDefinition } from './table/trading-market-list-table-record-source-definition';

export class TradingMarketsGridFrame extends GridSourceFrame {
    recordFocusedEventer: ScanFieldEditorFramesGridFrame.RecordFocusedEventer | undefined

    private _list: ChangeSubscribableComparableList<TradingMarket>;
    ...
    tryOpenList(list: ChangeSubscribableComparableList<TradingMarket>, keepView: boolean) {
    ...
    protected override getDefaultGridSourceOrReferenceDefinition() {
        const list = new ChangeSubscribableComparableList<TradingMarket>();
        return this.createListGridSourceOrReferenceDefinition(list, undefined);
    }

    protected override processGridSourceOpenedEvent() {
        const recordSource = this.grid.openedRecordSource as TradingMarketListTableRecordSource;
    ...
    private createListGridSourceOrReferenceDefinition(list: ChangeSubscribableComparableList<TradingMarket>, layoutDefinition: RevColumnLayoutOrReferenceDefinition | undefined) {
        const tableRecordSourceDefinition = new TradingMarketListTableRecordSourceDefinition(
