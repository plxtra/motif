...
export class ReviewMoveOrderRequestNgComponent extends ReviewOrderRequestComponentNgDirective implements OnDestroy {
    ...
    public readonly destinationAccountIdDisplay: string;
    ...
    constructor() {
        ...
        super(++ReviewMoveOrderRequestNgComponent.typeInstanceCreateCount);
        ...
        const destinationAccount = orderPad.getDestinationAccountIfOk();
        if (destinationAccount === undefined) {
            throw new AssertInternalError('RMIRCCDAI9888332312');
        } else {
            this.destinationAccountIdDisplay = destinationAccount.id.display;
