...
@Component({
    ...
    imports: [IntegerCaptionedRadioNgComponent, DataIvemIdSelectNgComponent, DataIvemIdListEditorNgComponent, IntegerEnumInputNgComponent, EnumArrayInputNgComponent, CaptionLabelNgComponent, IntegerTextInputNgComponent]
})
