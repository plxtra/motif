...
@Component({
    ...
    imports: [ExpandableCollapsibleLinedHeadingNgComponent, CaptionLabelNgComponent, CheckboxInputNgComponent, TextInputNgComponent, ScanEditorTargetsNgComponent, CaptionedCheckboxNgComponent]
})
