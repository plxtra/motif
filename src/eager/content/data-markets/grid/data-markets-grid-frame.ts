...
import { DelayedBadnessGridSourceFrame } from '../../internal-api';
import { LegacyTableRecordSourceDefinitionFactoryService } from '../../legacy-table-record-source-definition-factory-service';
import { DataMarketListTableRecordSource } from './table/data-market-list-table-record-source';
import { DataMarketListTableRecordSourceDefinition } from './table/data-market-list-table-record-source-definition';

export class DataMarketsGridFrame extends DelayedBadnessGridSourceFrame {
    recordFocusedEventer: ScanFieldEditorFramesGridFrame.RecordFocusedEventer | undefined

    private _list: ChangeSubscribableComparableList<DataMarket>;
    ...
    tryOpenList(list: ChangeSubscribableComparableList<DataMarket>, keepView: boolean) {
    ...
    protected override getDefaultGridSourceOrReferenceDefinition() {
        const list = new ChangeSubscribableComparableList<DataMarket>();
        return this.createListGridSourceOrReferenceDefinition(list, undefined);
    }

    protected override processGridSourceOpenedEvent() {
        const recordSource = this.grid.openedRecordSource as DataMarketListTableRecordSource;
    ...
    private createListGridSourceOrReferenceDefinition(list: ChangeSubscribableComparableList<DataMarket>, layoutDefinition: RevColumnLayoutOrReferenceDefinition | undefined) {
        const tableRecordSourceDefinition = new DataMarketListTableRecordSourceDefinition(
