...
export class SvgButtonNgComponent extends ControlComponentBaseNgDirective implements OnInit, AfterViewInit {
    ...
    private _iconComponent: SvgIconComponent;
    ...
    constructor() {
        ...
        this.inputId.set('SvgButton' + this.typeInstanceId);
    }
    ...
    ngAfterViewInit(): void {
        ...
        this._iconComponent = this._iconComponentSignal();
    }
    ...
    protected override setUiAction(action: IconButtonUiAction) {
        const pushEventHandlersInterface = super.setUiAction(action) as IconButtonUiAction.PushEventHandlersInterface;

        pushEventHandlersInterface.value = (value, edited) => this.handleValuePushEvent(value, edited);
        pushEventHandlersInterface.icon = (definition) => this.handleIconPushEvent(definition);
