import {
    addToArrayByPush,
    AssertInternalError, CommaText,
    compareInteger,
    ComparisonResult,
    Integer, isArrayEqual,
    Line,
    ModifierKey, MultiEvent, UnreachableCaseError
...
export namespace MenuBarService {
    ...
    export class RootMenu extends Menu {
        ...
        override get isRoot() { return true; }
    }
    ...
    export class ChildMenu extends Menu {
        ...
        override get isRoot() { return false; }
