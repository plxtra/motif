...
import { NumberUiAction, UiAction } from '@pbkware/ui-action';
import {
    StringId,
    Strings,
...
export abstract class NumberUiActionComponentBaseNgDirective extends ControlComponentBaseNgDirective {
    ...
    protected override setUiAction(action: NumberUiAction) {
        const pushEventHandlersInterface = super.setUiAction(action) as NumberUiAction.PushEventHandlersInterface;
