...
@Component({
    ...
    imports: [DataIvemIdSelectNgComponent, SvgButtonNgComponent, TextInputNgComponent, DateInputNgComponent, CommandBarNgComponent, WatchlistNgComponent, SplitComponent, SplitAreaComponent, DepthNgComponent, TradesNgComponent]
})
