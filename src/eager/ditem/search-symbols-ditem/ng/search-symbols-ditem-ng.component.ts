...
@Component({
    ...
    imports: [SvgButtonNgComponent, CaptionLabelNgComponent, ExchangeCaptionedRadioNgComponent, ExchangeSelectItemNgComponent, DataMarketCaptionedItemsCheckboxNgComponent, DataMarketSelectItemsNgComponent, TextInputNgComponent, IntegerCaptionedItemsCheckboxNgComponent, EnumArrayInputNgComponent, IntegerCaptionedRadioNgComponent, CaptionedCheckboxNgComponent, IntegerTextInputNgComponent, IntegerLabelNgComponent, ButtonInputNgComponent, SearchSymbolsNgComponent]
})
