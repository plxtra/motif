...
import { ApiError as ApiErrorApi, Badness as BadnessApi } from '../../../api';
    ...
    export namespace ReasonId {
        ...
        export function toApi(value: Badness.ReasonId): BadnessApi.Reason {
            switch (value) {
                ...
                case Badness.ReasonId.PublisherSubscriptionError_InvalidRequest_Error:
                    return BadnessApi.ReasonEnum.PublisherSubscriptionError_InvalidRequest_Error;
                ...
                case Badness.ReasonId.PublisherSubscriptionError_SubscriptionError_Error:
                    return BadnessApi.ReasonEnum.PublisherSubscriptionError_SubscriptionError_Error;
                ...
                case Badness.ReasonId.PublisherSubscriptionError_SubscriptionWarning_Suspect:
                    return BadnessApi.ReasonEnum.PublisherSubscriptionError_SubscriptionWarning_Suspect;
                case Badness.ReasonId.PublisherSubscriptionError_DataNotAvailable_Error:
                    return BadnessApi.ReasonEnum.PublisherSubscriptionError_DataNotAvailable_Error;
        ...
        export function fromApi(value: BadnessApi.Reason): Badness.ReasonId {
            ...
            switch (enumValue) {
                ...
                case BadnessApi.ReasonEnum.PublisherSubscriptionError_InvalidRequest_Error:
                    return Badness.ReasonId.PublisherSubscriptionError_InvalidRequest_Error;
                ...
                case BadnessApi.ReasonEnum.PublisherSubscriptionError_DataNotAvailable_Error:
                    return Badness.ReasonId.PublisherSubscriptionError_DataNotAvailable_Error;
                case BadnessApi.ReasonEnum.PublisherSubscriptionError_SubscriptionError_Error:
                    return Badness.ReasonId.PublisherSubscriptionError_SubscriptionError_Error;
                ...
                case BadnessApi.ReasonEnum.PublisherSubscriptionError_SubscriptionWarning_Suspect:
                    return Badness.ReasonId.PublisherSubscriptionError_SubscriptionWarning_Suspect;
